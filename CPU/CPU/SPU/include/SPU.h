...
typedef struct
{
    spu_err_t          error_code; /**< Error code indicating the status of the operation. */
    union Spu_sec_arg second_arg; /**< Second argument for SPU functions. */
} spu_ret_t;
 ...
 */
spu_err_t execute(const char *bin_file, const char *config_file,
