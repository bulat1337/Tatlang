 ...
 * @return spu_err_t Returns an error code indicating the status of the processing.
 */
 ...
 * @param config_file Pointer to the configuration file.
 * @return spu_err_t Returns an error code indicating the status of the constructor.
 */
spu_err_t VM_ctor(struct VM *vm, const char *config_file);
 ...
 */
spu_err_t VM_dtor(struct VM *vm);
