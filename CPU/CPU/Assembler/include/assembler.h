...
typedef struct
{
    asm_err_t          error_code; /**< Error code indicating the status of the operation. */
    union Asm_sec_arg second_arg; /**< Second argument for assembler functions. */
} asm_ret_t;
 ...
 */
asm_err_t  compile     (const char *file_name);
